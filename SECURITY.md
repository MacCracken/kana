...
If you discover a security vulnerability in kana, please report it
...
This policy covers the `kana` crate and its published API. Vulnerabilities
in dependencies should be reported to the respective upstream projects (and
flagged here if they affect kana users).
